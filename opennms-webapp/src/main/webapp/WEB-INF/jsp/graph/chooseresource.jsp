...
<%@page import="org.opennms.web.svclayer.ResourceService"%><jsp:include page="/includes/header.jsp" flush="false" >
  <jsp:param name="title" value="选择资源" />
  <jsp:param name="headTitle" value="选择" />
  ...
  <jsp:param name="breadcrumb" value="<a href='graph/index.jsp'>资源图</a>" />
  <jsp:param name="breadcrumb" value="选择" />
</jsp:include>
