...
<jsp:include page="/includes/header.jsp" flush="false" >
  <jsp:param name="title" value="故障详细" />
  <jsp:param name="headTitle" value="详细" />
  <jsp:param name="headTitle" value="故障" />
  <jsp:param name="breadcrumb" value="<a href='outage/list'>故障</a>" />
  <jsp:param name="breadcrumb" value="详细" />
</jsp:include>

      <!-- page title -->
      <h3>故障:<%=outage.getId()%></h3>
          
      <table class="standardfirst">
        <tr>
          <td class="standardheader" width="10%">节点:</td>
          <td class="standard">
        ...
        <tr>
          ...
          <td class="standardheader">服务服务时间:</td>
          <td class="standard">
          ...
          <td class="standardheader">服务服务事件:</td>
          <td class="standard">
