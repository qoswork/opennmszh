...
<h3>监视分类: ${fn:escapeXml(model.category.name)}</h3>

<p>
分类 '${fn:escapeXml(model.category.name)}' 有 ${fn:length(model.memberNodes)} 个节点。
</p>

<p>
<a href="admin/categories.htm?edit&categoryid=${model.category.id}">编辑分类</a>
</p>
