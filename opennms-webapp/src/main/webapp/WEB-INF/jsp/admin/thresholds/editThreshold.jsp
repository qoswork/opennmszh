...
<jsp:include page="/includes/header.jsp" flush="false">
	<jsp:param name="title" value="门限编辑" />
	<jsp:param name="headTitle" value="编辑门限" />
...
<h3>帮助</h3>
<p>
<b>说明</b>:一个可选的门限描述，以帮助确定他们的目的是什么。<br/>
<b>类型</b>:<br/>
...
<b>数据源类型</b>:"node"对应节点级数据项，"if"对应接口级数据项，或任何通用资源类型datacollection-config.xml中定义的。会忽略节点级过滤器配置。<br/>
