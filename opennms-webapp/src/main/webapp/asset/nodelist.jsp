...
<jsp:include page="/includes/header.jsp" flush="false" >
  <jsp:param name="title" value="资产列表" />
  <jsp:param name="headTitle" value="资产列表" />
  <jsp:param name="breadcrumb" value="<a href='asset/index.jsp'>资产</a>" />
  <jsp:param name="breadcrumb" value="资产列表" />
</jsp:include>
...
<h3>资产</h3>
  ...
  <% if( assets.length > 0 ) { %>
      <table class="standard">
        <tr>
          <td class="standardheader">匹配的文本</td>
          <td class="standardheader">资产链接</td>
          <td class="standardheader">节点链接</td>
        </tr>
