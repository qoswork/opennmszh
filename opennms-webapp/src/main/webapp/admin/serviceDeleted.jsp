...
<jsp:include page="/includes/header.jsp" flush="false" >
  ...
  <jsp:param name="breadcrumb" value="<a href='${nodeLink}'>节点</a>" />
  <jsp:param name="breadcrumb" value="<a href='${interfaceLink}'>接口</a>" />
  <jsp:param name="breadcrumb" value="服务已删除" />
</jsp:include>

<h3>完成已删除 <c:out value="<%=serviceName%>"/> 服务在 <c:out value="<%=ipAddr%>"/></h3>
<p>
