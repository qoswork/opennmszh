...
<jsp:include page="/includes/header.jsp" flush="false" >
  <jsp:param name="title" value="导入资产" />
  <jsp:param name="headTitle" value="导入资产" />
  <jsp:param name="breadcrumb" value="<a href='admin/index.jsp'>管理</a>" />
  <jsp:param name="breadcrumb" value="<a href='admin/asset/index.jsp'>导入/导出资产</a>" />
  <jsp:param name="breadcrumb" value="导入" />
</jsp:include>

<h3>资产</h3>

<p>
  粘贴逗号分隔的值到文本框中将导入到资产数据库。
  每行一条记录。字段间用逗号分隔。 
</p>
