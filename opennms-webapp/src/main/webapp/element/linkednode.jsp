...
<jsp:include page="/includes/header.jsp" flush="false" >
  ...
  <jsp:param name="headTitle" value="节点链路信息" />
  <jsp:param name="title" value="节点链路信息" />
  ...
  <jsp:param name="breadcrumb" value="链路" />
</jsp:include>
    ...
    <li>
	  ...
	  <li>
        <c:url var="resourceGraphsUrl" value="graph/chooseresource.htm">
          ...
          <a href="${fn:escapeXml(resourceGraphsUrl)}">资源图</a>
	  </li>
        <% } %>
        ...
        <% if( request.isUserInRole( Authentication.ROLE_ADMIN )) { %> 
           <li>
           <a href="admin/nodemanagement/index.jsp?node=<%=nodeId%>">管理</a>
           </li>
        <% } %>
	  </ul>
	  </div>
	...
	<div class="TwoColLeft">
			...
			<div class="boxWrapper">
			     <ul class="plain">
		            ...
		            <% if( isBridge ) { %>
		            <li>
						<a href="element/bridgenode.jsp?node=<%=nodeId%>">查看节点桥接/STP信息</a>
					</li>
		            <% }%>		
		         </ul>	     
			</div>
