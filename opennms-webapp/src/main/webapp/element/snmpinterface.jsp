...
<jsp:include page="/includes/header.jsp" flush="false" >
  <jsp:param name="title" value="SNMP接口" />
  <jsp:param name="headTitle" value="SNMP接口" />
...
function doDelete() {
     if (confirm("你确定你要继续吗？这一操作将永久删除这个接口，并不能撤消。"))
     {
...
%>
      ...
      <h2>接口: <%=(intf_db.getSnmpIfDescription() == null) ? "&nbsp;" : intf_db.getSnmpIfDescription()%>
      </h2>
...
<div id="contentright">
			...
			<% if (ifIndex > 0 ) { %>
            <% String eventHeader2 = "<a href='" + eventUrl2 + "'>最近发生的事件 (使用过滤 ifIndex = " + ifIndex + ")</a>"; %>
