...
<jsp:include page="/includes/header.jsp" flush="false" >
  <jsp:param name="title" value="告警级别图例" />
...
<table>
  <tr class="Critical">
    ...
    <td class="divider">该告警意味着网络上的许多设备都将受到影响。每个人都应该停止他们当前的工作，并重点解决这个问题。</td>
  </tr>
  <tr class="Major">
    <td class="bright">&nbsp;</td>
  ...
  <tr class="Warning">
    ...
    <td class="divider">告警发生，可能需要采取行动。。此严重性，，可以用来表示一个信号(记录)，但并不需要直接行动。</td>
  </tr>
  <tr class="Indeterminate">
    <td class="bright">&nbsp;</td>
    <td class="divider"><b>不确定</b></td>
    <td class="divider">没有级别可以关联到此告警。</td>
  </tr>
  <tr class="Normal">
    <td class="bright">&nbsp;</td>
  ...
  <tr class="Cleared">
    <td class="bright">&nbsp;</td>
    <td class="divider"><b>已清除</b></td><td class="divider">该告警表明，之前的错误已得到纠正并且服务已恢复</td>
  </tr>
</table>
